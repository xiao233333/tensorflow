...
TensorFlow Version: 1.4.0-gpu-py3
...
singularity pull --name tensorflow shub://marcc-hpc/tensorflow:1.4.0-gpu-py3
...
Download this file: `wget https://raw.githubusercontent.com/marcc-hpc/tensorflow/1.4.0-gpu-py3/tensorflow_job.sh`
