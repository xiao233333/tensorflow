...
wget -N https://raw.githubusercontent.com/marcc-hpc/tensorflow/1.4.0-gpu-py3/softmax_regression.py
...
singularity pull --name tensorflow.simg shub://marcc-hpc/tensorflow:1.4.0-gpu-py3
